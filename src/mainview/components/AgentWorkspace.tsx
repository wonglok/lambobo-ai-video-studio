...
export default function AgentWorkspace({ projectId }: Props) {
  ...
  const kindIcon = (f: WorkspaceFile) => {
    if (f.kind === "image")
      return <span className="text-ink-400">{ImageIcon}</span>;
    if (f.kind === "video")
      return <span className="text-ink-400">{VideoIcon}</span>;
    if (f.kind === "text")
                        ...
                        <>
                          {f.kind === "text" && (
                            <button
                              ...
                              className="p-1.5 text-ink-400 hover:bg-ink-600 rounded transition-colors"
                              title="Edit"
                            >
                              {PencilIcon}
                            </button>
              ...
              <div className="flex items-center justify-between px-3 py-2 bg-ink-900 border-b border-ink-600">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <button
                    ...
                    className="p-1 text-ink-400 hover:bg-ink-600 rounded transition-colors"
                    title="Close"
                  >
                    {CloseIcon}
                  </button>
