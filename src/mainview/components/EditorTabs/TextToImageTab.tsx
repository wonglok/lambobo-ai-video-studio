  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex items-center gap-2">
        <span className="text-tiffany-400">{ImageIcon}</span>
      ...
      <div>
        ...
        <p className="text-xs text-tiffany-400 mt-1.5">
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg border border-ink-600 text-red-400 hover:border-red-500/40 hover:bg-red-500/10 transition-colors"
            >
              {CloseIcon}
              Remove
            </button>
            ...
            {generatedImages.map((img) => {
              ...
              return (
                <button
                  ...
                  className="relative rounded-lg border border-ink-600 hover:border-tiffany-300 overflow-hidden transition-all cursor-zoom-in group"
                >
                  <img
                    src={fullUrl}
                    alt={img.filename}
