  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex items-center gap-2">
        <span className="text-tiffany-400">{SceneIcon}</span>
      ...
      {anyGenerating && (
        <button
          ...
          className="flex items-center justify-center gap-2 w-full px-4 py-2.5 bg-red-500/10 hover:bg-red-500/20 text-red-400 text-sm font-semibold rounded-xl border border-red-500/30 transition-colors"
        >
          {StopIcon}
          Stop Generation
        </button>
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="flex items-center justify-center w-6 h-6 rounded-full text-ink-400 hover:bg-red-500/10 hover:text-red-400 disabled:opacity-50 transition-colors"
                  title="Remove scene"
                >
                  {TrashIcon}
                </button>
