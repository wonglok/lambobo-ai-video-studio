        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <div className="flex flex-col items-start gap-2">
              <label className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-tiffany-200 bg-white text-tiffany-600 text-xs font-medium cursor-pointer hover:border-tiffany-300 hover:bg-tiffany-50 transition-colors">
                {UploadIcon}
