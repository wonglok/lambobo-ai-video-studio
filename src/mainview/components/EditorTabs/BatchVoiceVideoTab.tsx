  ...
  return (
    <div className="flex flex-col gap-5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <div className="flex flex-col items-start gap-2">
              <label className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-ink-600 bg-ink-800 text-ink-300 text-xs font-medium cursor-pointer hover:border-ink-400 hover:bg-ink-700 transition-colors">
                {UploadIcon}
      ...
      <div className="pt-3 border-t border-ink-700">
        ...
        {store.stitchError && (
          <div className="mt-2 p-4 bg-red-500/10 border border-red-500/30 rounded-xl text-red-400 text-sm">
            {store.stitchError}
          </div>
        )}
