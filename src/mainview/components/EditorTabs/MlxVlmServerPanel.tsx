        ...
        <div className="flex flex-wrap items-end gap-3">
          ...
          {store.agent.serverRunning || store.agent.starting ? (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-xs font-medium rounded-lg border transition-all bg-red-500/10 border-red-500/30 text-red-300 hover:border-red-400"
            >
              {StopIcon}
              Stop Server
            </button>
