...
function StatusBadge({ status }: { status: BatchI2VRowStatus }) {
  switch (status) {
    ...
    case "error":
      return <span className="text-xs font-medium text-red-400">Error</span>;
    default:
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg border transition-all bg-ink-800 border-ink-600 text-red-400 hover:border-red-500/40 hover:bg-red-500/10 disabled:opacity-50"
            >
              {CloseIcon}
              Clear
            </button>
                    ...
                    <td className="px-3 py-2">
                      <div className="flex flex-col gap-1">
                        <div className="flex items-center gap-1">
                          <span className="text-[10px] text-tiffany-400 w-10">
                            Img:
                          </span>
                      ...
                      {row.error && (
                        <p className="text-[10px] text-red-400 mt-1 break-words max-w-[120px]">
                          {row.error}
                        </p>
                      )}
                    </td>
                    ...
                    <td className="px-3 py-2">
                      <div className="flex flex-wrap gap-1">
                        ...
                        <button
                          ...
                          disabled={store.running}
                          title="Remove row"
                          className="flex items-center justify-center w-7 h-7 rounded-lg border border-ink-600 text-ink-300 hover:bg-red-500/10 hover:text-red-400 hover:border-red-500/40 transition-colors disabled:opacity-40"
                        >
                          {CloseIcon}
                        </button>
                      </div>
      ...
      {store.running ? (
        ...
        <div className="flex flex-col gap-2">
          <button
            ...
            className="flex items-center justify-center gap-2 w-full px-4 py-3 bg-tiffany-500 hover:bg-tiffany-400 active:bg-tiffany-600 disabled:bg-ink-600 disabled:text-ink-400 text-ink-950 text-sm font-semibold rounded-xl transition-all duration-150 shadow-glow hover:shadow-glow disabled:shadow-none"
          >
            {SparkleIcon}
