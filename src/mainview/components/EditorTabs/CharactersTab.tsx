  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex items-center gap-2">
        <span className="text-ink-400">{CharacterIcon}</span>
      ...
      <div className="flex flex-col gap-3">
        <div className="flex items-center gap-2">
          <span className="text-ink-400">{ImagesIcon}</span>
          ...
          <div className="bg-ink-800 rounded-2xl shadow-card p-5 w-[480px] max-w-full max-h-[80vh] flex flex-col">
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className="w-6 h-6 rounded-full text-ink-400 hover:bg-ink-600 hover:text-ink-100 flex items-center justify-center transition-colors"
                title="Close"
              >
                {CloseIcon}
              </button>
              ...
              <div className="grid grid-cols-3 gap-2 overflow-y-auto pr-1">
                {gen.projectImages.map((img) => (
                  <button
                    ...
                    className="relative rounded-lg border border-ink-600 hover:border-ink-500 overflow-hidden transition-colors"
                    title={img.filename}
                  >
                    <img
                      src={img.url}
