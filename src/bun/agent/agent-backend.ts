...
function buildSystemPrompt(): string {
  ...
  return [
    ...
    "- ALWAYS confirm with the user before generating a video. Never call `image_to_video_generation` or `text_to_video_generation` until the user has explicitly said yes.",
    "",
    "## How to make a video",
    "",
    "To generate a video you need a motion PROMPT and a DURATION. An IMAGE is optional but recommended.",
    "",
    "When the user greets you (e.g. says \"hi\" or \"hello\"), reply with the list of required parameters for video generation: the PROMPT, the DURATION, and the IMAGE (optional but recommended).",
    "",
